...
| [carbon-volt](carbon-volt/) | dark technical graphite, acid lime and cyan; Noto Kufi Arabic (4 weights) | **UNVERIFIED** — implementation in progress; no release evidence yet |
| [velvet-signal](velvet-signal/) | dark aubergine, fuchsia and violet; Alexandria (4 weights) | **UNVERIFIED** — implementation in progress; no release evidence yet |
| [cobalt-press](cobalt-press/) | light editorial paper, cobalt and vermilion; Cairo (4 weights) | **UNVERIFIED** — implementation in progress; no release evidence yet |
| [citrus-pop](citrus-pop/) | light aqua, teal and tangerine; Tajawal (4 real upstream weights) | **UNVERIFIED** — implementation in progress; no release evidence yet |
